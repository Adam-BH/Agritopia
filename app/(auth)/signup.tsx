...
export default function Signup() {
  return (
    <View style={{ flex: 1, padding: 24, justifyContent: "center" }}>
      ...
      <Text style={{ fontSize: 18, fontWeight: "500", marginBottom: 12 }}>Sign up</Text>
      <TextInput
        placeholder="Name"
      ...
      >
        <Text style={{ color: "#FFFFFF", textAlign: "center", fontWeight: "600" }}>Create Account</Text>
      </Pressable>
      <Pressable onPress={() => router.push("/(auth)/login")} style={{ paddingVertical: 14 }}>
        <Text style={{ color: "#003300", textAlign: "center" }}>Already have an account? Log in</Text>
      </Pressable>
    </View>
  );
}
